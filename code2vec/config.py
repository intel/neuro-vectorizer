...
class Config:
    ...
    def load_from_args(self):
        ...
        self.TRAIN_DATA_PATH_PREFIX = './data/for_loops/for_loops'#args.data_path#'./data/for_loops'
    ...
    def __init__(self, set_defaults: bool = False, load_from_args: bool = False, verify: bool = False):
        ...
        NV_DIR = os.environ['NeuroVectorizer_DIR']
        self.TRAIN_DATA_PATH_PREFIX: Optional[str] = NV_DIR + '/code2vec/data/for_loops/for_loops'#None
